function [fsi fsres qt k fs SkinQuake ToeQuake SkinDamping ToeDamping]=Model_ICP_18(j,i,T,sigv,Pa,CPT,z,z_D,A,Settings,phi,R_eqauv,Thichness,Diameter,Damping_Table)
