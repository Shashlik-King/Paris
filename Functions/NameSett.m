...
Settings.Database.status            = Sett.DatabaseSetting{11,2};
Settings.Database.responsible       = Sett.DatabaseSetting{12,2};
Settings.Database.preparer          = Sett.DatabaseSetting{13,2};
