...
for c=1:size(Data.loc,1)
    ...
    AppendixGeneration_LocationInput(Data,Settings,Data.loc{c,1},Data.loc{c,2})
    ...
    movefile(char(fullfile(pwd, 'AppendixTemplate.pdf')), char(fullfile(pwd,{['Appendix\AppendixPDA_' char(Data.loc{c,1}) '.pdf']})));
